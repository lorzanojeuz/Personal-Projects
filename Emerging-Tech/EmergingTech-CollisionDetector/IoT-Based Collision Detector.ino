...
int distance; 
float level;
const char* ssid = "baldoz2.4G"; 
const char* password = "encarnacion";
void send_event(const char *event);
const char *host = "maker.ifttt.com";
const char *privateKey = "m2NoKV0Cyy3sMBgzfinqt4I9RZO29_ogFKUzDS_ljb7";
...
String request = client.readStringUntil('\r'); 
    ...
    client.println("<h1>IoT-based Collision Detector</h1>");
    client.println("<div class=\"data\">");
    client.println("<div class=\"side_adjust text1\">Distance:  </div>");
    client.println("<div class=\"side_adjust data1\">");
    client.print(level);
    client.println("<div class=\"side_adjust text1\">% near</div>");
    client.println("</div>");
    client.println("</div>");
    client.println("</body>");
    client.println("</html>");
